...
I have created csv file upload page using Laravel with Vue JS. You need to upload csv file containing Homeowner data which was given as part of the task.

After csv file gets uploaded then the Person array data will be displayed in a table.
